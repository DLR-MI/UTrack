...
PATH_MIX = './datasets/mix/ablation_17'
os.system(f'mkdir -p {PATH_MIX}/annotations')

mot_json = json.load(open('/data/MOT17/annotations/train_half.json','r'))
...
mot_json_val_half = json.load(open('/data/MOT17/annotations/val_half.json','r'))
img_list_val = []
