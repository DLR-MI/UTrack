...
# Modified version of Ultralytics annotator
# Added a line width parameter to box_label function
...
class Annotator:
    ...
    def box_label(self, box, label="", color=(128, 128, 128), txt_color=(255, 255, 255), rotated=False, line_width=1):
        ...
        if self.pil or not is_ascii(label):
            if rotated:
                ...
                p1 = (box[0], box[1])
                self.draw.rectangle(box, width=line_width, outline=color)  # box
            if label:
