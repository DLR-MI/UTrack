...
PATH_MIX = './datasets/mix/ablation_20'
os.system(f'mkdir -p {PATH_MIX}/annotations')

mot_json = json.load(open('/data/MOT20/annotations/train_half.json','r'))
...
mot_json_val_half = json.load(open('/data/MOT20/annotations/val_half.json','r'))
img_list_val = []
for img in mot_json_val_half['images']:
    img['file_name'] = '/data/MOT20/train/' + img['file_name']
    img_list_val.append(img)

print('mot20_val_half')
